...
<div class="wrap" id="of_container">
  ...
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline;" id="ofform-reset">
    ...
    <input name="reset" type="submit" value="Reset Settings" class="button submit-button reset-button" onclick="return confirm('Is settings been reseted?');" />
...
<div style="margin-left:110px;">Designd & Coding : <a href="http://www.erhankilic.org" title="Erhan Kılıç">Erhan Kılıç</a></div>
<!--wrap-->
<?php
}
